...
public class StudentMain {
	...
	static {
		...
		data [0] = new Student("Shweta", new int[] {35, 35, 35});
		data [1] = new Student(null, new int[] {11, 22, 33});
		data [2] = null;
		data [3] = new Student("Sachin", null);
		data [4] = new Student("Manshi", new int[] {90, 92, 80}); // TC1
		data [5] = new Student("Shreya", new int[] {35, 40, 50}); // TC2
		data [6] = new Student("Kamini", new int[] {25, 29, 28}); // TC3
		data [7] = null; // TC4
